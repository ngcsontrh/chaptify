...
- Chạy chương trình
- Chọn chức năng **Extract**
- Nhập đường dẫn file epub
- Tool sẽ tự tạo thư mục chứa các file text ở cùng chỗ với file gốc

## Lưu ý

- Chỉ hỗ trợ file `.epub` chuẩn
- File text xuất ra là **UTF-8**
